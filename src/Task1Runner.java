...
import task1.index.IndexOfAnElement;
import task1.sum.SumOfValues;
import task1.remove.RemoveAnElement;
import task1.insert.InsertAnElement;
import task1.test.TestAnElement;
import task1.maxmin.MaxAndMinElement;
import task1.common.FindCommonElement;
import task1.duplicateremoval.RemoveDuplicate;
import task1.oddeven.NumberOfOddEven;
import task1.average.AverageExceptMaxMin;
import task1.target.TargetValueSum;
import task1.revarray.ReverseAnArray;
import task1.evenodd.PrintEvenOdd;
import task1.sortarray.SortAnArray;
import task1.leaders.LeadersOfTheArray;
import java.util.*;
